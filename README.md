...
# Сюжет: В конце самый главный босс это ты

**Сюжет для рогалика в современном мире: "КОД: АПОКАЛИПСИС"**  

---

### **Пролог: Нулевой пациент**  
*(Короткий кат-сценарий: камера наблюдения в метро)*  
Вы — обычный курьер, доставляющий посылки по мегаполису **Нью-Эдем**. Однажды вам приходит заказ: доставить чёрный кейс с пометкой *"Эксперимент № 23"*. При попытке открыть его — взрыв света. На записи с камер остаётся лишь силуэт, расправляющийся с бандой грабителей, а потом исчезающий в переулке.  
**Первый геймплей:** Вы очнулись в заброшенном метро. Ваша рука светится неоново-синим. Начальное оружие: **"Импульсный клинок"** (ближняя атака с эффектом электрического удара).  

---

### **Акт 1: Город в осаде**  
**Цель:** Выжить и понять, что происходит.  
- **Локация:** Улицы мегаполиса, небоскрёбы, подземные паркинги. Враги: корпоративные дроны, наёмники в экзоскелетах.  
- **Босс:** **Секьюрити-бот "Цербер"** — трёхглазая машина с пушками, которая прижимает вас к краю крыши.  
- **Новое оружие:** **"Самонаводящийся дрон"** (выстреливает мини-дронами, атакующими ближайших врагов).  
- **Сюжетный триггер:** В метро вы находите терминал с данными: *"Эксперимент №23 — наноботы, переписывающие ДНК. Вы — первый стабильный образец. Уничтожьте или доставьте живым".*  

---

### **Акт 2: Война корпораций**  
**Цель:** Уничтожить **корпорацию «ЭDEN CORE»**, создавшую наноботов.  
- **Локация:** Офисные башни, серверные фермы, секретные лаборатории.  
- **Босс:** **CEO Ли Маркус** — киборг, чьё тело на 70% состоит из механики. Его атаки: лазерные импульсы и вызов подкрепления.  
- **Новое оружие:** **"ЭМИ-шторм"** (создаёт зону, отключающую электронику врагов).  
- **Механика:** После босса вы получаете **"Ауру гнева"** — враги в радиусе 5 метров получают урон от перегрузки наноботов.  

---

### **Акт 3: Коллапс реальности**  
**Цель:** Остановить **Сингулярность** — момент, когда наноботы начнут перестраивать всю материю.  
- **Локация:** Искажённые зоны: здания растут как деревья, машины плавают в воздухе. Враги: мутанты, сливающиеся с техникой.  
- **Босс:** **Директор Адамс** — ваш бывший клиент, чьё сознание теперь контролирует наноботов.  
  - **Фаза 1:** Он телепортируется, создавая иллюзии.  
  - **Фаза 2:** Сливается с Сингулярностью — атакует чёрными дырами, затягивающими в центр.  
- **Новое оружие:** **"Волна хаоса"** (толкает врагов и наносит урон от разрыва пространства).  

---

### **Финал: Выбор пути**  
**Цель:** Решить судьбу мира.  
- **Босс:** **Сингулярность** в виде гигантского древа из энергии и металла.  
- **Механика:** Каждые 10 секунд меняется гравитация (пол становится стеной, потолком).  
- **Финальный выбор:**  
  1. **"Перезагрузить"** — уничтожить Сингулярность, но потерять все наноботы (ваш персонаж становится обычным человеком).  
  2. **"Возглавить"** — возглавить перестройку мира, став божеством-диктатором (открывает режим *"Эволюция"* с новыми оружием).  
  3. **"Сбежать"** — телепортироваться в другую вселенную (секретная концовка, требует 100% коллекционных предметов).  

---

### **Особенности геймплея:**  
- **Система "Эволюция":** Каждые 5 минут игры наноботы мутируют, давая случайный навык (напр., **"Ледяная неминуемость"** — заморозка земли под врагами).  
- **Динамический мир:** Здания рушатся, враги адаптируются к вашему стилю боя (если часто используете дроны — появляются антисамолётные турели).  
- **Реинкарнация:** При смерти вы возрождаетесь в метро, но наноботы "запоминают" 1 случайный врага — его можно призвать как союзника.  

---

**Концовки:**  
- **Плохая:** Стать диктатором — мир превращается в цифровую пустыню, а враги заменяются на роботов.  
- **Хорошая:** Уничтожить Сингулярность — открывает доступ к оружию **"Гнев небес"** (молнии, которые могут лечить союзников).  
- **Секретная:** Найти "Древо кода" — получить контроль над всеми наноботами в мире (требует победить 3 скрытых боссов).  

--- 

**Механика оружия в современном мире:**  
- **"Хаос небытия"** — взрывающиеся дроны, появляющиеся из поражённых врагов.  
- **"Стазис вечной муки"** — замедляющая зона, которая работает даже на боссов.  
- **"Кулаки рока"** — телепортационные удары, пробивающие укрытия.  

Геймплей сочетает скорость рогаликов с элементами метроидвании (открой новое оружие, чтобы пройти в старые локации).
